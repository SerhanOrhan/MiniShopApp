...
namespace MiniShopApp.WebUI.Identity
{
    public static class SeedIdentity
    {
        ...
        {
            var roles = configuration.GetSection("UserData:Roles").GetChildren().Select(r => r.Value).ToArray(); //aspsettings içerisindeki bilgileri alıyoruz.
            ...
            foreach (var section in users.GetChildren())
            {
                ...
                var firtName = section.GetValue<string>("FirstName");
