    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.ConfigureApplicationCookie(options =>
            {
                ...
                options.AccessDeniedPath = "/account/accessdenied";//yetkin yok senýn demek için yaptýgýmýz url
                options.SlidingExpiration = true; // istek gönderirse sýfýrla sureyý demek
                options.ExpireTimeSpan = TimeSpan.FromMinutes(20);//20 dk ýstek yapmazsa 20dk sonra kullanýcý giriþinden çýkýlýr.
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env,UserManager<User> userManager,RoleManager<IdentityRole> roleManager,ICardService cardService)
        {
            ...
            //Buraya kullanýcý bilgilerini oluþturacak metodumuz cagýran kodu yazacaðýz.
