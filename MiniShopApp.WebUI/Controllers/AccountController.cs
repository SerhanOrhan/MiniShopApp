    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterModel model) //asenkron bir method bu şekilde oluşturulur
        {
            ...
            if (result.Succeeded)//Başarılı bir şekilde create gerçekleştiyse
            {
                ...
                await _emailSender.SendEmailAsync(model.Email,"MiniShopApp Confirm Account!",$"Lütfen email adresinizi onaylamak içi <a href='https://localhost:5001{url}'>tıklayınız!</a>");
                TempData["Message"] = JobManager.CreateMessage("","Kayit işleminizi tamamlamak için mailinize gönderilen onaylama linkine tıklayınız!", "warning");
        ...
        public async Task<IActionResult> ConfirmEmail(string userId,string token)
        {
            ...
            {
                TempData["Message"] = JobManager.CreateMessage("","Bir sorun oluştu", "warning");
                return View();
            }
            ...
            TempData["Message"] = JobManager.CreateMessage("","Hesabınız onaylanamamıştır! Lütfen daha sonra tekrar deneyiniz.", "danger");
            return View();
        }
        ...
        public async Task<IActionResult> ForgotPassword(string email)
        {
            ...
            if (user==null)
            {
                TempData["Message"] = JobManager.CreateMessage("","Böyle bir email adresi bulunamadı, lütfen kontrol ederek tekrar deneyınız","danger");
                return View();
            }
            ...
            await _emailSender.SendEmailAsync(
                email,"MiniShopApp Şifre Sıfırlama",
                $"Lütfen paralonızı yenilemek için  <a href='https://localhost:5001{url}'>Tıklayınız</a>"
                );
            TempData["Message"] = JobManager.CreateMessage("","Şifre sıfırlama maili kayıtlı mail adresine gonderilmiştir lütfen kontrol ediniz.", "warning");
        ...
        public IActionResult ResetPassword(string userId,string token)
        {
            if (userId==null || token==null)
            {
                TempData["Message"] = JobManager.CreateMessage("","Bir sorun oluştu daha sonra tekrar deneyiniz.", "danger");
        ...
        public async  Task<IActionResult> ResetPassword(ResetPasswordModel model)
        {
            ...
            if (user==null)
            {
                TempData["Message"] = JobManager.CreateMessage("","Bir sorun oluştu lütfen bilgileri kontrol ederek tekrar deneyınız", "danger");
                return View();
            }
