...
{
    [ApiController]
    [Route("api/[controller]")] //controller ismi yazarak  linkte sorgulama yapıyoruz.
    public class ProductsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetProducts()
        {
            ...
            //DTO(Data Transfer Object) kullanarak, veriyi istek sahibine 
            //belirlediğimiz bigileri içerecek şekilde yollayacağız.
